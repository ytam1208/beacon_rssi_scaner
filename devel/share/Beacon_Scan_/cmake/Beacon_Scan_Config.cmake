...
if(NOT "/home/cona/beacon/src/Beacon_Scan_/include " STREQUAL " ")
  set(Beacon_Scan__INCLUDE_DIRS "")
  set(_include_dirs "/home/cona/beacon/src/Beacon_Scan_/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Beacon_Scan_' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cona/beacon/src/Beacon_Scan_/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cona/beacon/devel/lib;/opt/ros/kinetic/lib)
